...
python trainer.py --config_file=./configs/train_main/ --exp_name srdiff_maxvit_ltae_ckpt --hparams="diff_net_ckpt=/my_data/Results/LDM_LCC_FLAIR_HUB_HR_INFER/checkpoints/srdiff_maxvit_ltae_ckpt" --infer
